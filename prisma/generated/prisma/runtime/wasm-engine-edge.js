    ...
    ni.exports = (function () {
        ...
        return function (e, r) {
            ...
            var a = 0,
                ...
                Y = [];
            for (f = 0; f < i; f++)
                (Y.push(f + 1), Y.push(e.charCodeAt(s + f)));
...
var Tt = class {
    ...
    async stop() {
        if (
            ...
            return (
                ge('library is already stopping'),
                this.libraryStoppingPromise
            );
...
${a.backtrace}`,
    ...
    getExternalAdapterError(e, r) {
        if (e.error_code === Rl && r) {
            ...
            return (
                Bt(i, 'External error with reported id was not registered'),
                i
            );
        }
    }
