...
var O = (e, r, t) => (
    ...
    Pu = (e) => Oo(jt({}, '__esModule', { value: !0 }), e);
var hi = ue((_g, is) => {
    'use strict';
...
`
    ...
    function dp(e) {
        ...
        let i = [r];
        if (e && e.path)
            if (!Array.isArray(e.path)) i = [vs(e.path)];
            else {
                i = [];
    ...
    be = (e, r, t) => {
        ...
        if (ui(e)) {
            ...
            if (Array.isArray(e)) {
                ...
                return (
                    e.length === r.length && e.every((s, a) => be(s, r[a], t))
                );
            }
...
async function rc(e) {
    ...
    if (
        (n || (n = await Jo(['/lib64', '/usr/lib64', '/lib', '/usr/lib'])), n)
    ) {
        ee(
...
function Yt(e) {
    return oc(async () => {
        let r = await Hu(e);
        return (
            ee(`Command "${e}" successfully returned "${r.stdout}"`),
            r.stdout
        );
    });
}
...
var dd = (e) => e,
    ...
    P = {
        ...
        disableWorkerMessageHandler:
            Pn.Prism && Pn.Prism.disableWorkerMessageHandler,
        util: {
            encode: function (e) {
                if (e instanceof ge) {
                    let r = e;
...
function Un(e = {}) {
    return (r) => (
        typeof e._count == 'boolean' && (r._count = r._count._all),
        r
    );
}
function Ma(e, r) {
...
\`\`\``
            : '',
        c =
            wr(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
            ...
            (this.startPromise !== void 0 && (await this.startPromise),
                (this.startPromise = (async () => {
                    ...
                    ((this.host = t.host),
                        ...
                        (this.remoteClientVersion = await Il(
                            this.host,
                            this.config
                        )),
                        $t('host', this.host),
...
You may have to run ${qe('prisma generate')} for your changes to take effect.`,
    ...
    async stop() {
        if (
            ...
            return (
                Re('library is already stopping'),
                this.libraryStoppingPromise
            );
    ...
    async request(r, { traceparent: t, interactiveTransaction: n }) {
        ...
        try {
            ...
            if (s.code === 'GenericFailure' && s.message?.startsWith('PANIC:'))
                throw new ae(vo(this, s.message), this.config.clientVersion);
...
${a.backtrace}`,
    ...
    buildQueryError(r, t) {
        if (r.user_facing_error.is_panic)
            return new ae(
                vo(this, r.user_facing_error.message),
                this.config.clientVersion
            );
    ...
    getExternalAdapterError(r, t) {
        if (r.error_code === hf && t) {
            ...
            return (
                ln(i, 'External error with reported id was not registered'),
                i
            );
        }
    }
...
var So =
        ...
        (t) => {
            ...
            if (Vn(t))
                ...
                let [o, ...s] = t;
                ((n = o),
                    (i = { values: Wr(s || []), __prismaRawParameters__: !0 }));
            } else
                switch (r) {
                    case 'sqlite':
                    case 'mysql': {
