...
var Pi = Ve((nt) => {
    ...
    function Ct(e, t, r) {
        throw Math.floor(e) !== e
            ? (rt(e, r),
              new et.ERR_OUT_OF_RANGE(r || 'offset', 'an integer', e))
            : t < 0
...
R.inverseTangent = R.atan = function () {
    ...
    if (u.isFinite()) {
        ...
        if (h + 4 <= Rn)
            return ((s = be(g, h + 4, T).times(0.5)), (s.s = u.s), s);
    }
    for (
        g.precision = a = h + 10,
            g.rounding = 1,
...
\`\`\``
            : '',
        g =
            ot(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
var er = class {
    ...
    async stop() {
        if (
            ...
            return (
                Te('library is already stopping'),
                this.libraryStoppingPromise
            );
...
${a.backtrace}`,
    ...
    getExternalAdapterError(t, r) {
        if (t.error_code === Lp && r) {
            ...
            return (
                ur(i, 'External error with reported id was not registered'),
                i
            );
        }
    }
...
var Zn =
        ...
        (r) => {
            ...
            if (Br(r))
                ...
                let [o, ...s] = r;
                ((n = o),
                    (i = { values: vt(s || []), __prismaRawParameters__: !0 }));
            } else
                switch (t) {
                    case 'sqlite':
                    case 'mysql': {
