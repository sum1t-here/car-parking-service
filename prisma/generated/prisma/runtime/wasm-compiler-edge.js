    ...
    _s.exports = (function () {
        ...
        return function (t, r) {
            ...
            var a = 0,
                ...
                pe = [];
            for (f = 0; f < i; f++)
                (pe.push(f + 1), pe.push(t.charCodeAt(s + f)));
            ...
            for (; a < o; )
                for (
                    M = r.charCodeAt(s + (E = a)), C = ++a, f = 0;
                    f < Ke;
                    f += 2
                )
                    ((L = pe[f]),
                        (pe[f] = C = e(L, E, C, M, pe[f + 1])),
                        (E = L));
            return C;
        };
    })();
    ...
    if (
        (n
            ? (a.push(
              ...
              a.push(
                  s.red(
                      `It occurred in the ${s.bold(`\`${e}\``)} invocation${f}`
                  )
              ))
...
\`\`\``
            : '',
        A =
            ht(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
function Ji(e, t, r, n) {
    switch (r.type) {
        ...
        case 'datetime': {
            if (typeof e == 'string')
                return { $type: 'DateTime', value: Rm(e) };
        ...
        switch (t.type) {
            ...
            case 'let': {
                ...
                for (let s of t.args.bindings) {
                    let { value: a } = await this.interpretNode(
                        s.expr,
                        r,
                        o,
                        i
                ...
                for (let a of o) {
                    let f = await this.#u(a, r, () =>
                        r
                            .queryRaw(a)
                            .catch((E) =>
                                t.args.type === 'rawSql' ? Gi(E) : _t(E)
                            )
                    );
                    s === void 0
                        ? (s = f)
                        : (s.rows.push(...f.rows),
                          (s.lastInsertId = f.lastInsertId));
                }
                return {
            ...
            case 'unique': {
                ...
                if (o.length > 1)
                    throw new Error(
                        `Expected zero or one element, got ${o.length}`
                    );
            ...
            case 'validate': {
                ...
                return (
                    ac(o, t.args.rules, t.args),
                    { value: o, lastInsertId: s }
                );
            }
            case 'if': {
                let { value: o } = await this.interpretNode(
                    t.args.value,
                    r,
                    n,
                    i
            ...
            case 'diff': {
                ...
                return {
                    value: To(o).filter((f) => !a.has(JSON.stringify(f))),
                };
            }
            case 'process': {
                let { value: o, lastInsertId: s } = await this.interpretNode(
...
async function Gd() {
    return (
        globalThis.crypto ?? (await Promise.resolve().then(() => (Xe(), Ei)))
    );
}
async function uc() {
    ...
    Ao = class {
        ...
        async request({ method: t, path: r, headers: n, body: i, fetch: o }) {
            ...
            return (
                ...
                (this.#r =
                    f.headers.get('Accelerate-Query-Engine-Jwt') ?? void 0),
                this.#s(s, f),
                f
            );
        }
            ...
            (this.startPromise !== void 0 && (await this.startPromise),
                (this.startPromise = (async () => {
                    ...
                    ((this.host = r.host),
                        ...
                        (this.remoteClientVersion = await Tc(
                            this.host,
                            this.config
                        )),
                        Hr('host', this.host),
...
var No =
        ...
        (r) => {
            ...
            if (In(r))
                ...
                let [o, ...s] = r;
                ((n = o),
                    (i = { values: Gt(s || []), __prismaRawParameters__: !0 }));
            } else
                switch (t) {
                    case 'sqlite':
                    case 'mysql': {
...
function eu(e) {
    class t {
        ...
        constructor(n) {
            ((e = n?.__internal?.configOverride?.(e) ?? e),
                $a(e),
                n && zc(n, e));
